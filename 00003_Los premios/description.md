El jurado de un torneo nos pidió que definamos la función `medalla_segun_puesto` que retorne la medalla que le corresponde a los primeros puestos, según la siguiente lógica:
